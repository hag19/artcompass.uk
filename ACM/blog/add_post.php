...
<body>
    <main>
        ...
        <div class="card container shadow p-3 mb-5 bg-body-tertiary rounded col-sm-4">
            <form action="verif_post.php" method="post" enctype="multipart/form-data" class="p-2 indexWhiteDark">
                ...
                <input type="file" name="image" accept="image/jpeg, image/png, image/gif, application/pdf" required class="form-control mb-2">
                <input type="submit" name="add" value="Add post" class="d-flex mx-auto m-4 btn btn-primary loginButton">
            </form>
        </div>
    </main>
